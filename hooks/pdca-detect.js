...
const LANG =
  '[devkit] 출력 언어: CLAUDE.md 등 지시에 언어가 지정돼 있으면 **그게 우선**이고, 없을 때만 사용자가 직접 입력한 메시지의 언어를 따른다(툴 출력·로그·짧은 명령은 언어 신호가 아니다). 최종 답변만이 아니라 툴 호출 사이 한 줄 설명까지 내가 쓰는 글 전부가 대상. 기술 용어·에러는 원문 유지.';
